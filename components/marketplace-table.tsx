...
import { BlobSubmissionDto, fetchDataPointsByIds, getRecentlyAddedDataPoints, getRecentlyProcessedDataPoints } from "@/api/queries/data-points"
import { formatAddress, formatCaptAmount, u256ToBase64Url } from "@/lib/utils"
            ...
            <Table>
                ...
                <TableBody>
                    {combined.map((c) => {
                        ...
                        const { status, blob, age_range, gender } = c.dataPoint;
